    ...
    <table width="100%">
        <thead>
            <tr>
                ...
                <td width="250px">
                    <span style="color: {{ $setting['default_invoice_color'] }};font-size: 20px"
                        class="tu">Invoice</span><br>
        ...
        <tr class="invoice-items">
            <td colspan="2">
                <table class="items-table">
                    <thead
                        style="border-top: 1px solid {{ $setting['default_invoice_color'] }};border-bottom: 1px solid {{ $setting['default_invoice_color'] }}">
                        <tr class="tu">
                            <th style="color: {{ $setting['default_invoice_color'] }}">#</th>
                            <th style="color: {{ $setting['default_invoice_color'] }}">
                                Task</th>
                            <th style="color: {{ $setting['default_invoice_color'] }}">
                                Hours</th>
                            <th class="text-right" style="color: {{ $setting['default_invoice_color'] }}">
                                Total Amount</th>
                        </tr>
                    </thead>
                    <tbody>
